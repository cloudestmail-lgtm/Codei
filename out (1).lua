...
local function main()
	...
	ConsoleFrame["BackgroundColor3"] = Color3.fromRGB(22, 22, 28);
	...
	G2L["3"]["BackgroundColor3"] = Color3.fromRGB(18, 18, 24);
	...
	G2L["4"]["Thickness"] = 1.5;
	G2L["4"]["Color"] = Color3.fromRGB(60, 80, 140);
	...
	G2L["5"]["ScrollBarImageColor3"] = Color3.fromRGB(60, 80, 140);
	...
	G2L["6"]["PlaceholderColor3"] = Color3.fromRGB(90, 90, 115);
	G2L["6"]["BorderSizePixel"] = 0;
	G2L["6"]["TextSize"] = 13;
	G2L["6"]["TextColor3"] = Color3.fromRGB(212, 212, 228);
	...
	G2L["backgroundOutput"]["BackgroundColor3"] = Color3.fromRGB(18, 18, 24);
	...
	G2L["a"]["TopImage"] = '';
	G2L["a"]["BackgroundColor3"] = Color3.fromRGB(18, 18, 24);
	...
	G2L["a"].ScrollBarImageColor3 = Color3.fromRGB(55, 75, 140)
	...
	G2L["c"]["Thickness"] = 1.5;
	G2L["c"]["Color"] = Color3.fromRGB(40, 55, 110);
	...
	G2L["10"]["BackgroundColor3"] = Color3.fromRGB(30, 30, 40);
	...
	G2L["11"]["PlaceholderColor3"] = Color3.fromRGB(80, 80, 105);
	G2L["11"]["BorderSizePixel"] = 0;
	G2L["11"]["TextWrapped"] = true;
	G2L["11"]["TextSize"] = 15;
	G2L["11"]["TextColor3"] = Color3.fromRGB(200, 200, 220);
	...
	G2L["13"]["Color"] = Color3.fromRGB(60, 80, 140);


	-- StarterGui.ScreenGui.Console.Clear
	G2L["14"] = Instance.new("ImageButton", ConsoleFrame);
	G2L["14"]["BorderSizePixel"] = 0;
	G2L["14"]["BackgroundColor3"] = Color3.fromRGB(38, 38, 52);
	...
	G2L["17"]["TextSize"] = 15;
	G2L["17"]["TextColor3"] = Color3.fromRGB(180, 185, 200);
	...
	G2L["19"]["BackgroundColor3"] = Color3.fromRGB(38, 38, 52);
	...
	G2L["20"]["BackgroundColor3"] = Color3.fromRGB(38, 38, 52);
	...
	G2L_MODULES[G2L["1d"]] = {
		Closure = function()
			...
			local colors = {
				numbers = Color3.fromRGB(255, 185, 50),
				boolean = Color3.fromRGB(255, 185, 50),
				operator = Color3.fromRGB(180, 180, 200),
				lua = Color3.fromRGB(86, 200, 255),
				exploit = Color3.fromRGB(180, 100, 255),
				rbx = Color3.fromRGB(255, 100, 120),
				str = Color3.fromRGB(150, 230, 120),
				comment = Color3.fromRGB(85, 95, 115),
				null = Color3.fromRGB(255, 185, 50),
				call = Color3.fromRGB(255, 235, 120),
				self_call = Color3.fromRGB(255, 235, 120),
				local_color = Color3.fromRGB(255, 100, 120),
				function_color = Color3.fromRGB(255, 100, 120),
				self_color = Color3.fromRGB(255, 100, 120),
				local_property = Color3.fromRGB(100, 170, 255),
			}
	...
	Console.Init = function()
		...
		if CtrlScroll == true then
			Console.CtrlScroll.BackgroundColor3 = Color3.fromRGB(0, 110, 200)
		elseif CtrlScroll == false then
			Console.CtrlScroll.BackgroundColor3 = Color3.fromRGB(38, 38, 52)
		end
		...
		if AutoScroll == true then
			Console.AutoScroll.BackgroundColor3 = Color3.fromRGB(0, 110, 200)
		elseif AutoScroll == false then
			Console.AutoScroll.BackgroundColor3 = Color3.fromRGB(38, 38, 52)
		end
...
return search]==]
	...
	Explorer.Init = function()
		...
		local explorerItems = create({
			...
			{2,"Frame",{BackgroundColor3=Color3.fromRGB(24,24,32),BorderSizePixel=0,Name="ToolBar",Parent={1},Size=UDim2.new(1,0,0,22),}},
			{3,"Frame",{BackgroundColor3=Color3.fromRGB(18,18,25),BorderColor3=Color3.fromRGB(40,45,80),BorderSizePixel=0,Name="SearchFrame",Parent={2},Position=UDim2.new(0,3,0,1),Size=UDim2.new(1,-6,0,18),}},
			{4,"TextBox",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,ClearTextOnFocus=false,Font=3,Name="SearchBox",Parent={3},PlaceholderColor3=Color3.fromRGB(80,85,110),PlaceholderText="Search workspace",Position=UDim2.new(0,4,0,0),Size=UDim2.new(1,-24,0,18),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=0,}},
			{5,"UICorner",{CornerRadius=UDim.new(0,4),Parent={3},}},
			{6,"UIStroke",{Thickness=1.2,Parent={3},Color=Color3.fromRGB(50,60,120)}},
			...
			{8,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image="rbxassetid://5034718129",ImageColor3=Color3.fromRGB(100,110,160),Parent={7},Size=UDim2.new(0,16,0,16),}},
			...
			{11,"Frame",{BackgroundColor3=Color3.fromRGB(18,18,24),BorderSizePixel=0,Name="ScrollCorner",Parent={1},Position=UDim2.new(1,-16,1,-16),Size=UDim2.new(0,16,0,16),Visible=false,}},
...
local function main()
	...
	Lib.ScrollBar = (function()
		...
		local function new(hor)
			...
			obj:Texture({
				ThumbColor = Color3.fromRGB(50,55,80),
				ThumbSelectColor = Color3.fromRGB(65,75,110),
				ArrowColor = Color3.new(1,1,1),
				FrameColor = Color3.fromRGB(18,18,24),
				ButtonColor = Color3.fromRGB(40,42,60)
			})
			return obj
		end
	...
	Lib.Window = (function()
		...
		local theme = {
			MainColor1 = Color3.fromRGB(28,28,36),
			MainColor2 = Color3.fromRGB(22,22,30),
			Button = Color3.fromRGB(40,42,58)
		}
...
DefaultSettings = (function()
	...
	return {
		...
		Theme = {
			_Recurse = true,
			Main1 = rgb(30,30,36),       -- deep panel bg
			Main2 = rgb(24,24,30),       -- deeper secondary bg
			Outline1 = rgb(18,18,22),    -- frame borders
			Outline2 = rgb(50,50,62),    -- button borders
			Outline3 = rgb(15,15,20),    -- textbox borders
			TextBox = rgb(20,20,26),     -- input bg
			Menu = rgb(18,18,24),        -- menu bg
			ListSelection = rgb(0,120,200), -- selection accent (vivid blue)
			Button = rgb(42,42,52),      -- button bg
			ButtonHover = rgb(55,55,70), -- button hover
			ButtonPress = rgb(25,25,35), -- button pressed
			Highlight = rgb(65,65,82),   -- highlight
			Text = rgb(220,220,230),     -- main text
			PlaceholderText = rgb(90,90,110), -- placeholder
			Important = rgb(255,70,70),  -- errors/important
			ExplorerIconMap = "",
			MiscIconMap = "",
			Syntax = {
				Text = rgb(212,212,220),
				Background = rgb(20,20,26),
				Selection = rgb(255,255,255),
				SelectionBack = rgb(0,100,180),
				Operator = rgb(180,180,200),
				Number = rgb(255,185,50),
				String = rgb(150,230,120),
				Comment = rgb(90,100,115),
				Keyword = rgb(255,100,120),
				Error = rgb(255,60,60),
				FindBackground = rgb(130,100,0),
				MatchingWord = rgb(70,70,90),
				BuiltIn = rgb(86,200,255),
				CurrentLine = rgb(30,40,60),
				LocalMethod = rgb(255,235,120),
				LocalProperty = rgb(100,170,255),
				Nil = rgb(255,185,50),
				Bool = rgb(255,185,50),
				Function = rgb(255,100,120),
				Local = rgb(255,100,120),
				Self = rgb(255,100,120),
				FunctionName = rgb(255,235,120),
				Bracket = rgb(180,180,200)
			},
		},
		ScriptViewer = {
			ShowMoreInfo = true;
